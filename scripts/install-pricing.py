...
paths=['infra/pricing/worker.py','infra/pricing/adapters/liara.py','infra/pricing/adapters/arvan.py','infra/pricing/adapters/parsvds.py','infra/torob-cloud-pricing.service','infra/gateway.py','infra/dashboards/torob-pricing.json','migrations/004_pricing_packages.sql','.runtime/pricing-sources.json']
